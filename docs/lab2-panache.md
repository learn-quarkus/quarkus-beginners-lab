...
Add the following new item. Note that this payload doesn't have an **"id"**  since this be autogenerated.
...
1. Find the **Hibernate ORM** card and click **HQL Console**
4. In the **Entity Types** list, choose the **`MenuItem`** table name link — this opens a live SQL query browser against your H2 database with `from MenuItem` prefilled
